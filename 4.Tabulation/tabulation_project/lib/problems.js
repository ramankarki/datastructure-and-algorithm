...
//     let nextSteps = nums.slice(currentIndex + 1, nums[currentIndex] + 1);

//     if (nextSteps.length < 1) return false;
//     if (nextSteps.length === 1) {
//       if (nextSteps[0] + currentIndex < lastIndex) return false;
//     }

//     let highestStep = nextSteps[0];
//     let highestStepIndex = currentIndex + 1;

//     for (
//       let nextStep = highestStepIndex;
//       nextStep <= nums[currentIndex];
//       nextStep++
//     ) {
//       if (nums[nextStep] >= highestStep) {
//         highestStep = nums[nextStep];
//         highestStepIndex = nextStep;
//       }
//     }

//     currentIndex = highestStepIndex;
//   }
...
//     if (diff >= 0) coinsNum.push(minChange(coins, diff, memo) + 1);
//   }

//   memo[amount] = Math.min(...coinsNum);
